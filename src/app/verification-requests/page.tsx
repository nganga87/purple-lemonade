...
export type VerificationRequest = typeof initialRequests[0];
        ...
        <Sidebar>
          ...
          <SidebarContent>
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                 <SidebarMenuButton href="/verification-requests" isActive>
                  <CheckCircle2 />
        ...
        <SidebarInset className="flex-1 flex flex-col">
          <header className="sticky top-0 z-10 flex h-16 items-center justify-between border-b bg-background/80 backdrop-blur-sm px-4 md:px-6">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-2xl font-headline font-semibold">Verification Requests</h1>
            </div>
            <div className="flex items-center gap-4">
          ...
          <main className="flex-1 p-4 md:p-6 lg:p-8">
            <Card className="shadow-lg">
                <CardHeader>
                    ...
                    <CardDescription>Review, approve, or reject requests to use your verified addresses.</CardDescription>
                </CardHeader>
                <CardContent>
                    <Table>
                        <TableHeader>
