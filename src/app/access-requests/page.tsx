                        ...
                        <TableHeader>
                            ...
                            <AlertDialog>
                                ...
                                <AlertDialogContent>
                                    ...
                                    {/* This assumes we have a request to delete. In a real app, you'd manage this state better. */}
                                    <AlertDialogAction onClick={() => requests.length > 0 && handleDeleteRequest(requests[0].id)}>
                                        Continue
                                    </AlertDialogAction>
                                    </AlertDialogFooter>
                                </AlertDialogContent>
