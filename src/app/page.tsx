...
const activityItems = [
  {
    ...
    date: '2024-07-29',
    status: 'Completed',
    icon: <Image src="https://placehold.co/32x32/3399FF/FFFFFF.png" alt="Amazon logo" width={32} height={32} className="rounded-full" />,
  },
  {
    type: 'Verification',
    vendor: 'Post Office',
    date: '2024-07-28',
    status: 'Confirmed',
    icon: <Image src="https://placehold.co/32x32/33CC33/FFFFFF.png" alt="Post office logo" width={32} height={32} className="rounded-full" />,
  },
  {
    type: 'Service Call',
    vendor: 'Gas Company',
    date: '2024-07-27',
    status: 'Completed',
    icon: <Image src="https://placehold.co/32x32/FF9900/FFFFFF.png" alt="Gas company logo" width={32} height={32} className="rounded-full" />,
  },
  {
    type: 'Food Delivery',
    vendor: 'Uber Eats',
    date: '2024-07-26',
    status: 'Completed',
    icon: <Image src="https://placehold.co/32x32/000000/FFFFFF.png" alt="Uber Eats logo" width={32} height={32} className="rounded-full" />,
  },
];
